  	...
  	<div class="innerwrapa">
  		<h1 class="h1_heada">음식점</h1>
  			<div class="introducea boxing">		
  				<div class="lefta box">
  					<div class="imgWrapa">
  						<img src="images/모치플레지르.png">
  					</div>
  				</div>
  				<div class="righta box">
  					<h3 class="tit">- 모치플레지르 -</h3>
  					<ul class="conta">
  						<li>
  						<span>주&nbsp;&nbsp;&nbsp;소</span>
  						부산광역시 수영구 광안동 수영로545번길 17-17
  						</li>
  						<li>
  						<span>연 락 처</span>
  						051-978-5978
  				 ...
  				 <div class="botha">
  				 	<p> 안녕하세요.
						부산 수영구 광안리에 위치한 모치플레지르 입니다. 
						모든 브런치메뉴 선정에 있어 전문가들과 함께 신중하게 메뉴얼링 하였습니다. 
						최상의 재료를 사용하여 수제로 만든 브런치와 음료, 젤라또를 준비하였습니다. 
						또한, 반려동물과 함께 브런치를 즐기실 수 있도록 매장 1층 내부와 테라스를 개방하였습니다. 
						각박한 도심생활 여러분들의 마음 속 오아시스가 되고자 합니다.
  				 </p>	 
  				</div>
            ...
            <div class="imgs">
               <ul>
                   <li>
                  <img alt="사진1" src="images/모치플레지르1.png" style="width:330px; height:250px;">
                  </li>
                  <li>
                  <img alt="사진2" src="images/모치플레지르3.png" style="width:330px; height:250px;">
                  </li>
                  <li>
                  <img alt="사진3" src="images/모치플레지르2.png" style="width:330px; height:250px;">
                  </li>
               </ul>
            </div>
      </div> 
  				...
  				<div id="map" style="width:1400px;height:500px;"></div>
					<script type="text/javascript" 
		 			...
		 			<script>
							...
							var options = {
									center: new kakao.maps.LatLng(35.15387353691079, 129.11116819710318),
									level: 1
							};

							var map = new kakao.maps.Map(container, options);
							
							var markerPosition  = new kakao.maps.LatLng(35.15387353691079, 129.11116819710318);
							...
							var iwContent = '<div style="padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;모치플레지르</div>',
						    	iwPosition = new kakao.maps.LatLng(35.15387353691079, 129.11116819710318); //인포윈도우 표시 위치입니다
