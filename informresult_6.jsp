  	...
  	<div class="innerwrap">
  		<h1 class="h1_head">관광안내소</h1>
  			<div class="introduce boxing">		
  				<div class="left box">
  					<div class="imgWrap">
  						<img src="https://www.visitbusan.net/uploadImgs/files/infofc/20200103090251202_thumbL">
  					</div>
  				</div>
  				<div class="right box">
  					<h3 class="tit">- 부산항 국제여객터미널관광안내소 -</h3>
  					<ul class="cont">
  						<li>
  						<span>주&nbsp;&nbsp;&nbsp;소</span>
  						부산광역시 동구 충장대로 206 (2층 2A19호)
  						</li>
  						<li>
  						<span>연 락 처</span>
  						051-465-3471
  				 ...
  				 <div class="both">
  				 	<p> 부산항 국제여객부두터미널 입국장(2층)에 위치하고 있으며, 연중무휴로 운영되며, 내·외국인 부산관광 정보안내, 무료 와이파이존, 
  				 	스마트기기 충전, PC 검색 등 다양한 서비스 및 부산의 다양한 홍보물을 비치하여 부산여행에 알찬 정보를 제공하고 있습니다. 
  				 	※ 코로나19로 인한 국제여객노선 잠정중단으로 관광안내소 임시휴무중
  				 </p>	 
  				</div>
  				<h5 class="h5">지도</h5>
  				<div id="map" style="width:1400px;height:500px;"></div>
					<script type="text/javascript" 
		 			...
		 			<script>
							...
							var options = {
									center: new kakao.maps.LatLng(35.11779858825748, 129.04964832660247),
									level: 1
							};

							var map = new kakao.maps.Map(container, options);
							
							var markerPosition  = new kakao.maps.LatLng(35.11779858825748, 129.04964832660247); 
							...
							var iwContent = '<div style="padding:5px;">여객터미널안내소</div>',
						     iwPosition = new kakao.maps.LatLng(35.11779858825748, 129.04964832660247); //인포윈도우 표시 위치입니다
