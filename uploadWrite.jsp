...
<body>
   ...
   <div class="container">
   <div class="row">
   <form name = "form" method="post" encType = "multipart/form-data" action="uploadWriteAction.jsp">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>					
						<tr>
							<td colspan="5" ><input type="text" class="form-control" placeholder="글 제목"  maxlength="50"></td>
						</tr>
						<tr>
							<td colspan="5" ><textarea class="form-control" placeholder="글 내용"  maxlength="2048" style="height:350px;"></textarea></td>
						</tr>
						<tr><td>
							파일 : <input type="file" name="file" id="image" accept="image/*" onchange="setThumbnail(event);">
