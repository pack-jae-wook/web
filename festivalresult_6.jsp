  	...
  	<div class="innerwrapb">
  		<h1 class="h1_headb">축제&행사</h1>
  			<div class="introduceb boxing">		
  				<div class="leftb box">
  					<div class="imgWrapb">
  						<img src="images/삼락벚꽃축제.png">
  					</div>
  				</div>
  				<div class="rightb box">
  					<h3 class="tit">- 삼락벚꽃축제 -</h3>
  					<ul class="contb">
  						<li>
  						<span>주&nbsp;&nbsp;&nbsp;소</span>
  						부산광역시 사상구 삼락생태공원 일원
  				 ...
  				 <div class="bothb">
  				 	<p> 만개한 벚꽃이 12킬로미터의 터널을 만들어주는 삼락벚꽃축제가 한창이다.
								...
								"**축제 취소 안내**
								신종 코로나바이러스(코로나19) 감염 확산 방지를 위해 삼락 벚꽃 축제는 취소되었음을 알려드립니다.(재개 시 별도 안내)"
            ...
            <div class="imgs">
               <ul>
                   <li>
                  <img alt="사진1" src="images/삼락벚꽃축제1.png" style="width:330px; height:250px;">
                  </li>
                  <li>
                  <img alt="사진2" src="images/삼락벚꽃축제2.png" style="width:330px; height:250px;">
                  </li>
                  <li>
                  <img alt="사진3" src="images/삼락벚꽃축제3.png" style="width:330px; height:250px;">
                  </li>
               </ul>
            </div>
      </div> 
  				...
  				<div id="map" style="width:1400px;height:500px;"></div>
					<script type="text/javascript" 
		 			...
		 			<script>
							...
							var options = {
									center: new kakao.maps.LatLng(35.16872206906415, 128.9735617553848),
									level: 3
							};

							var map = new kakao.maps.Map(container, options);
							
							var markerPosition  = new kakao.maps.LatLng(35.16872206906415, 128.9735617553848);
							...
							var iwContent = '<div style="padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;삼락벚꽃축제</div>',
						    	iwPosition = new kakao.maps.LatLng(35.16872206906415, 128.9735617553848); //인포윈도우 표시 위치입니다
