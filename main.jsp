...
<body>
   ...
   <div class="container">
      <div class="jumbotron">
         <div class="container">
            <h1>부산 한 눈에 보기</h1>
            <p>원하는 지역을 클릭하세요!
            <p><a class="btn btn-primary btn-pull" href="maincourse.jsp" role="button">자세히 알아보기</a></p>
         </div>
      </div>
   </div>
   ...
   <div class="container">
      ...
      <a class="left carousel-control" href="#myCarousel" data-selide="prev">
         <span class=" glphicon glphicon-chevron-left"></span>
      </a>
      <a class="right carousel-control" href="#myCarousel" data-selide="next">
         <span class=" glphicon glphicon-chevron-right"></span>
      </a>
      </div>
   </div>   
