  	...
  	<div class="innerwrapa">
  		<h1 class="h1_heada">음식점</h1>
  			<div class="introducea boxing">		
  				<div class="lefta box">
  					<div class="imgWrapa">
  						<img src="images/옹헤야.png">
  					</div>
  				</div>
  				<div class="righta box">
  					<h3 class="tit">- 옹헤야불백 -</h3>
  					<ul class="conta">
  						<li>
  						<span>주&nbsp;&nbsp;&nbsp;소</span>
  						부산 중구 구덕로34번길 4 뉴남포빌딩
  						</li>
  						<li>
  						<span>연 락 처</span>
  						070-4216-0484
            ...
            <div class="imgs">
               <ul>
                   <li>
                  <img alt="사진1" src="images/옹헤야1.png" style="width:330px; height:250px;">
                  </li>
                  <li>
                  <img alt="사진2" src="images/옹헤야2.png" style="width:330px; height:250px;">
                  </li>
                  <li>
                  <img alt="사진3" src="images/옹헤야3.png" style="width:330px; height:250px;">
                  </li>
               </ul>
            </div>
      </div> 
  				...
  				<div id="map" style="width:1400px;height:500px;"></div>
					<script type="text/javascript" 
		 			...
		 			<script>
							...
							var options = {
									center: new kakao.maps.LatLng(35.09845926615952, 129.03253698301032),
									level: 1
							};

							var map = new kakao.maps.Map(container, options);
							
							var markerPosition  = new kakao.maps.LatLng(35.09845926615952, 129.03253698301032);
							...
							var iwContent = '<div style="padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;옹헤야</div>',
						    	iwPosition = new kakao.maps.LatLng(35.09845926615952, 129.03253698301032); //인포윈도우 표시 위치입니다
