  		...
  		<h1 class="h1_heada">음식점</h1>
  			<div class="introducea boxing">		
  				...
  				<div class="righta box">
  				 ...
  				 <div class="botha">
  				 	<p> 남포동에 위치한 작은점포의 일본식 미니화로 한우참숯구이 전문점
								한우 갈비,등심,안심,낙엽살을1++ 등급의 질좋은 고기를 사용합니다
								한우를 부위별로 즐길수 있는곳!!!
  				 </p>	 
  				</div>
            ...
            <div class="imgs">
               <ul>
                   <li>
                  <img alt="사진1" src="images/규1.png" style="width:330px; height:250px;">
                  </li>
                  <li>
                  <img alt="사진2" src="images/규2.png" style="width:330px; height:250px;">
                  </li>
                  <li>
                  <img alt="사진3" src="images/규3.png" style="width:330px; height:250px;">
                  </li>
               </ul>
            </div>
      </div> 
  				...
  				<div id="map" style="width:1400px;height:500px;"></div>
					<script type="text/javascript" 
		 			...
		 			<script>
							...
							var options = {
									center: new kakao.maps.LatLng(35.09834870515996, 129.0330534642302),
									level: 1
							};

							var map = new kakao.maps.Map(container, options);
							
							var markerPosition  = new kakao.maps.LatLng(35.09834870515996, 129.0330534642302);
							...
							var iwContent = '<div style="padding:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;규</div>',
						    	iwPosition = new kakao.maps.LatLng(35.09834870515996, 129.0330534642302); //인포윈도우 표시 위치입니다
